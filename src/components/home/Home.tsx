...
export default function Home(){
    return(
        ...
        <main className="grid grid-cols-1 lg:grid-cols-2 h-screen w-full">
            <div className="relative flex items-center justify-center bg-[url(public/image/bg-home.jpg)] bg-no-repeat bg-cover">
                <div className="absolute inset-0 bg-black/50 backdrop-blur-sm"></div>
            </div>
            <div className="flex flex-col justify-center">
                <div className="p-10 flex flex-row">
                    <div>
                        <img className="w-72" src="public/image/Logo.svg" alt="" />
